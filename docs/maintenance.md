...
Current check inventory: No custom CI workflow exists yet. Do not configure nonexistent required checks. Add Python and MySQL validation first, then select their emitted job names.
...
TODO: complete the scoped acceptance criteria in the [engineering follow-up](https://github.com/marinasofia/equity-sql-analytics/issues/1).
